...
Frankly, `format()` is a bit verbose and is not recommended in systems f-strings can be used.
...
tabulate is a third-party Python library that makes it easy to display tabular data in a clean, readable format. It supports plain-text tables, Markdown, HTML, LaTeX, and more.

It’s especially useful for printing reports, summaries, or CLI output where well-aligned tables improve readability.
...
headers = ["Name", "Shares", "Purchase Price", "Current Price"]
...
```bash
Name      Shares    Purchase Price    Current Price
------  --------  ----------------  ----------------
AA          100              32.20             91.10
IBM          50              70.40            135.00
```

tabulate is a great tool for any CLI or text-based report you want to make more professional and user-friendly.
...
returns a list of named tuples containing the rows of the above table.
