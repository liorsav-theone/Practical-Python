[Contents](../Contents.md) \| [Previous (2.3 Formatting)](03_Formatting.md) \| [Next (2.5 List Comprehensions)](05_List_comprehension.md)
...
Oh no! it failed, for now the dictinaries you create for each stock doesn't not save the number of shares and the price of each stock as an int and float.
For now you can manually adapt them, later in this course we will clean this code.
