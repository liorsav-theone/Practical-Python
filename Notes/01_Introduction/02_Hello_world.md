...
You can create these files with your favorite text editor. I strongly recommend vscode
as it provides built in Terminal and great python syntax highlighting.
...
>
> For this exercise I will save you the time it takes to google the required information
> and say that the thickness of one dollar bill is 0.11 mm and the height of the
> Sears tower is 442 meters.

Before looking at the solution try to give it a few minutes to solve this by yourself.
...
The following section covers foundational concepts that every programmer should
be familiar with. If you're already comfortable with these topics, feel free to
...
The statements indented below the `while` will execute as long as the expression
after the `while` is `true`.
...
You can use variables. The text printed will be the value of the variable, not
the name.
...
Sometimes you need to specify an empty code block. The keyword `pass` is used
for it.
...
The following code fragment contains code from the Sears tower problem.  It also
has a bug in it.
...
[Contents](../Contents.md) \| [Previous (1.1 Python)](01_Python.md) \|
[Next (1.3 Numbers)](03_Numbers.md)
