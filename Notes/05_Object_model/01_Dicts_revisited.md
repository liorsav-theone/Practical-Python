...
The section above is from the original course. However, I (Lior Savransky) cannot express enough how much multiple inheritance (also known as diamond inheritance) is a complex and dangerous coding style. Even if you think you're skilled enough to use it, your teammates may not be. Do everything you can to avoid multiple inheritance. It is mentioned here only so that you're not surprised when encountering it in someone else's code — not so that you will use it in your own.
