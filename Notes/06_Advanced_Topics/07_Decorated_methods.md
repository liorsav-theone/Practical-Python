[Contents](../Contents.md) \| [Previous (6.6 Decorators)](06_Function_decorators.md) \| [Next (7 Packages)](../07_Packages/00_Overview.md)

# 6.7 Decorated Methods
...
### Exercise 6.15: Class Methods in Practice
...
class Portfolio:
...
    def append(self, stock: Stock) -> None:
